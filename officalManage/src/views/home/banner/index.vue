<template>
  <div id="banner" class="container">
    ...
    <div class="table">
      ...
      <el-tabs v-model="activeName" type="card" @tab-click="switchList">
      ...
      >
        ...
        <el-table-column prop="mediaId" label="编号" sortable width="200">
          <template slot-scope="scope">{{ scope.row.mediaId ? scope.row.mediaId.substring(6) : "" }}</template>
        </el-table-column>
        ...
        <el-table-column label="图片预览" width="650">
          <template slot-scope="scope">
            <img :src="scope.row.mediaUrl" alt="图片加载失败" :title="scope.row.title" height="200" />
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="addImg('update', scope.row)">编辑</el-button>
            <el-button type="danger" size="small" @click="deleteRow(scope.row.mediaId)">删除</el-button>
            <el-button
    ...
    <!-- 弹出框 -->
    <el-dialog :title="operateType ? '修改' : '添加'" :visible.sync="show_Dialog">
      <el-form :model="change_form" label-width="100px">
        ...
        <el-form-item label="图片预览" v-show="operateType">
        ...
        <!-- 下拉选择 -->
        <el-form-item label="上传到" v-if="!operateType">
          <el-select v-model="change_form.data.scene" placeholder="请选择" @change="changeUpPar">
            <el-option
