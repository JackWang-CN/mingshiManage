  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="交易方名称" label-width="100px">
        <el-input v-model="find_form.data.iename" placeholder="请输入交易方名称"></el-input>
      </el-form-item>
      <el-form-item label="图标地址" label-width="100px">
        <el-input v-model="find_form.data.picourl" placeholder="请输入图标地址"></el-input>
      </el-form-item>
      <el-form-item label="流水类型" label-width="100px">
        <el-input v-model="find_form.data.flowType" placeholder="请输入流水类型"></el-input>
      </el-form-item>
      <el-form-item label="消费类型" label-width="100px">
        <el-input v-model="find_form.data.payType" placeholder="请输入消费类型"></el-input>
      </el-form-item>
      <el-form-item label="描述" label-width="100px">
        <el-input v-model="find_form.data.describe" placeholder="请输入描述"></el-input>
      </el-form-item>
      <el-form-item label="金币值" label-width="100px">
        <el-input v-model="find_form.data.goldCoinVal" placeholder="请输入金币值"></el-input>
      </el-form-item>
      <el-form-item label="当前总金额" label-width="100px">
        <el-input v-model="find_form.data.totalGoldCoinVal" placeholder="请输入当前总金额"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="iename" label="交易方名称" width="120"></el-table-column>
      <el-table-column fixed prop="picourl" label="图标地址" width="80"></el-table-column>
      <el-table-column prop="flowType" label="流水类型" width="120"></el-table-column>
      <el-table-column prop="iename" label="交易方名称" width="120"></el-table-column>
      <el-table-column fixed prop="payType" label="消费类型" width="80"></el-table-column>
      <el-table-column prop="describe" label="描述" width="120"></el-table-column>
      <el-table-column prop="goldCoinVal" label="金币值" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        ...
        <el-form-item label="交易方名称">
          <el-input v-model="add_form.iename" placeholder="请输入交易方名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="图标地址">
          <el-input v-model="add_form.picourl" placeholder="请输入图标地址" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="流水类型">
          <el-input v-model="add_form.flowType" placeholder="请输入流水类型" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="消费类型">
          <el-input v-model="add_form.payType" placeholder="请输入消费类型" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="add_form.describe" placeholder="请输入描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="金币值">
          <el-input v-model="add_form.goldCoinVal" placeholder="请输入金币值" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="当前总金额">
          <el-input v-model="add_form.totalGoldCoinVal" placeholder="请输入当前总金额" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item label="交易方名称">
          <el-input v-model="edit_form.iename" placeholder="请输入交易方名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="图标地址">
          <el-input v-model="edit_form.picourl" placeholder="请输入图标地址" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="流水类型">
          <el-input v-model="edit_form.flowType" placeholder="请输入流水类型" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="消费类型">
          <el-input v-model="edit_form.payType" placeholder="请输入消费类型" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="edit_form.describe" placeholder="请输入描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="金币值">
          <el-input v-model="edit_form.goldCoinVal" placeholder="请输入金币值" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="当前总金额">
          <el-input v-model="edit_form.totalGoldCoinVal" placeholder="请输入当前总金额" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  mounted() {
    ...
    getDataList("u1", "Accflow", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("u1", "Accflow",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("u1", "Accflow",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("u1", "Accflow",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("u1", "Accflow",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
