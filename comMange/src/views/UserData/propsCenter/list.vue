<template>
  <div id="props_list" class="shadow_container">
    ...
    <el-table :data="data_list" border style="width: 100%" @selection-change="select">
      ...
      <el-table-column prop="listingTime" label="上架时间" width="100"></el-table-column>
      <el-table-column prop="dismountTime" label="下架时间" width="100"></el-table-column>
      <el-table-column prop="creationtime" label="创建时间" width="100"></el-table-column>
