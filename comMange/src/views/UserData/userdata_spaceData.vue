  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="空间位置信息" label-width="100px">
        <el-input v-model="find_form.data.spaceinfo" placeholder="请输入空间位置信息"></el-input>
      </el-form-item>
      <el-form-item label="空间维度信息" label-width="100px">
        <el-input v-model="find_form.data.centralpoint" placeholder="请输入空间维度信息"></el-input>
      </el-form-item>
      <el-form-item label="空间类型" label-width="100px">
        <el-select v-model="find_form.data.spacetype" placeholder="请选择空间类型">
          <el-option label="用户上传" value="0"></el-option>
          <el-option label="系统指定" value="1"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="空间状态" label-width="100px">
        <el-select v-model="find_form.data.spacestate" placeholder="请选择空间状态">
      ...
      <el-form-item label="允许误差范围" label-width="100px">
        <el-input v-model="find_form.data.allowErrRan" placeholder="请输入允许误差范围"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="spaceinfo" label="空间位置信息" width="120"></el-table-column>
      <el-table-column prop="centralpoint" label="空间维度信息" width="120"></el-table-column>
      <el-table-column prop="spacetype" label="空间类型" width="120">
        <template slot-scope="scope">{{scope.row.spacetype == '1'?'系统指定':'用户上传'}}</template></el-table-column>
      <el-table-column prop="spacestate" label="空间状态" width="120">
        <template slot-scope="scope">{{scope.row.spacestate == '1'?'不可用(禁止抢占)':'正常使用'}}</template></el-table-column>
      <el-table-column prop="allowErrRan" label="允许误差范围" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="空间位置信息">
          <el-input v-model="add_form.spaceinfo" placeholder="请输入空间位置信息" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="空间维度信息">
          <el-input v-model="add_form.centralpoint" placeholder="请输入空间维度信息" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="允许误差范围">
          <el-input v-model="add_form.allowErrRan" placeholder="请输入允许误差范围" autocomplete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="空间位置信息">
          <el-input v-model="edit_form.spaceinfo" placeholder="请输入空间位置信息" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="空间维度信息">
          <el-input v-model="edit_form.centralpoint" placeholder="请输入空间维度信息" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="空间类型">
        ...
        <el-form-item label="空间状态">
        <el-select v-model="edit_form.spacestate" placeholder="请选择空间状态">
          <el-option label="不可用(禁止抢占)" value="0"></el-option>
          <el-option label="正常使用" value="1"></el-option>
        </el-select>
        </el-form-item>
        <el-form-item label="允许误差范围">
          <el-input v-model="edit_form.allowErrRan" placeholder="请输入允许误差范围" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="资源id">
