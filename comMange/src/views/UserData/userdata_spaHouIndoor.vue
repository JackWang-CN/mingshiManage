  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="房产ID" label-width="100px">
        <el-input
          v-model="find_form.data.spaHouId"
          placeholder="请输入房产ID"
        ></el-input>
      </el-form-item>
      <el-form-item label="道具ID" label-width="100px">
        <el-input
          v-model="find_form.data.propid"
          placeholder="请输入道具ID"
        ></el-input>
      </el-form-item>
      <el-form-item label="用户ID" label-width="100px">
        <el-input
          v-model="find_form.data.uid"
          placeholder="请输入用户ID"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="三维空间坐标" label-width="100px">
        <el-input
          v-model="find_form.data.thrDiCoor"
          placeholder="请输入三维空间坐标"
        ></el-input>
      </el-form-item>
      <el-form-item label="道具类型" label-width="100px">
        <el-select
          v-model="find_form.data.proptype"
          placeholder="请选择道具类型"
        >
      ...
      <el-form-item label="道具状态" label-width="100px">
        <el-select
          v-model="find_form.data.propstate"
          placeholder="请选择道具状态"
        >
      ...
      <el-form-item label="道具模型参数信息" label-width="100px">
        <el-input
          v-model="find_form.data.auxDataInfo"
          placeholder="请输入道具模型参数信息"
        ></el-input>
      </el-form-item>
