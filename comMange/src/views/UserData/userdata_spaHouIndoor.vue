...
<template>
  <div id="store" class="shadow_container">
    <div class="pageTitle">道具数据管理</div>
    <!-- 查询条件 -->
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="房产ID" label-width="100px">
        <el-input v-model="find_form.data.spaHouId" placeholder="请输入房产ID"></el-input>
      </el-form-item>
      <el-form-item label="道具ID" label-width="100px">
        <el-input v-model="find_form.data.propid" placeholder="请输入道具ID"></el-input>
      </el-form-item>
      ...
      <el-form-item label="三维空间坐标" label-width="100px">
        <el-input v-model="find_form.data.thrDiCoor" placeholder="请输入三维空间坐标"></el-input>
      </el-form-item>
      <el-form-item label="道具类型" label-width="100px">
        <el-select v-model="find_form.data.proptype" placeholder="请选择道具类型">
          <el-option label="房产道具" value="0"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="道具状态" label-width="100px">
        <el-select v-model="find_form.data.propstate" placeholder="请选择道具状态">
          <el-option label="正常" value="0"></el-option>
          <el-option label="冻结" value="1"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="道具模型参数信息" label-width="100px">
        <el-input v-model="find_form.data.auxDataInfo" placeholder="请输入道具模型参数信息"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="spaHouId" label="房产ID" width="80"></el-table-column>
      ...
      <el-table-column prop="proptype" label="道具类型" width="120">
        <template slot-scope="scope">{{scope.row.proptype == '0'?'房产道具':'无'}}</template></el-table-column>
      <el-table-column prop="propstate" label="道具状态" width="120">
        <template slot-scope="scope">{{scope.row.propstate == '1'?'冻结':'正常'}}</template></el-table-column>
      <el-table-column prop="expiretime" label="到期时间" width="120"></el-table-column>
      <el-table-column prop="auxDataInfo" label="道具模型参数信息" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="道具ID">
          <el-input v-model="add_form.propid" placeholder="请输入道具ID" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="三维空间坐标">
          <el-input v-model="add_form.thrDiCoor" placeholder="请输入三维空间坐标" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="道具类型">
        <el-select v-model="add_form.proptype" placeholder="请选择道具类型">
          <el-option label="房产道具" value="0"></el-option>
        </el-select>
        </el-form-item>
        <el-form-item label="道具状态">
        <el-select v-model="add_form.propstate" placeholder="请选择道具状态">
          <el-option label="正常" value="0"></el-option>
          <el-option label="冻结" value="1"></el-option>
        </el-select>
        </el-form-item>
        <el-form-item label="道具模型参数信息">
          <el-input v-model="add_form.auxDataInfo" placeholder="请输入道具模型参数信息" autocomplete="off"></el-input>
        </el-form-item>       
      </el-form>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item label="三维空间坐标">
          <el-input v-model="edit_form.thrDiCoor" placeholder="请输入三维空间坐标" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="道具类型">
        <el-select v-model="edit_form.proptype" placeholder="请选择道具类型">
          <el-option label="房产道具" :value="0"></el-option>
        </el-select>
        </el-form-item>
        <el-form-item label="道具状态">
        <el-select v-model="edit_form.propstate" placeholder="请选择道具状态">
          <el-option label="正常" :value="0"></el-option>
          <el-option label="冻结" :value="1"></el-option>
        </el-select>
        </el-form-item>
        <el-form-item label="道具模型参数信息">
          <el-input v-model="edit_form.auxDataInfo" placeholder="请输入道具模型参数信息" autocomplete="off"></el-input>
        </el-form-item>     
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  mounted() {
    ...
    getDataList("u1", "Spahouindoor", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("u1", "Spahouindoor",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("u1", "Spahouindoor",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        var del = {
              "tableId":val["tableId"],
              "spaHouId":val["spaHouId"],
              "propid":val["propid"]
          }
        deleteuser("u1", "Spahouindoor",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("u1", "Spahouindoor",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
