  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="道具资产表id" label-width="100px">
        <el-input v-model="find_form.data.aId" placeholder="请输入道具资产表id"></el-input>
      </el-form-item>
      <el-form-item label="用户ID" label-width="100px">
        <el-input v-model="find_form.data.userId" placeholder="请输入用户ID"></el-input>
      </el-form-item>
      <el-form-item label="数量" label-width="100px">
        <el-input v-model="find_form.data.resId" placeholder="请输入数量"></el-input>
      </el-form-item>
      <el-form-item label="获得途径" label-width="100px">
        <el-input v-model="find_form.data.getFrom" placeholder="请输入获得途径"></el-input>
      </el-form-item>
      <el-form-item label="是否已绑定">
        <el-select v-model="find_form.data.isBind" placeholder="请选择是否已绑定">
          <el-option label="是" value="1"></el-option>
          <el-option label="否" value="0"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="是否冻结">
        <el-select v-model="find_form.data.isFrozen" placeholder="请选择是否冻结">
          <el-option label="启用" value="1"></el-option>
          <el-option label="禁用" value="0"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="是否永久">
        <el-select v-model="find_form.data.isForever" placeholder="请选择是否永久">
          <el-option label="启用" value="1"></el-option>
          <el-option label="禁用" value="0"></el-option>
        </el-select>
      </el-form-item>      
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="aId" label="道具资产表id" width="80"></el-table-column>
      ...
      <el-table-column prop="getFrom" label="获得途径" width="120"></el-table-column>
      <el-table-column fixed prop="isBind" label="是否已绑定" width="80"></el-table-column>
      <el-table-column prop="isFrozen" label="是否冻结" width="120">
        <template slot-scope="scope">{{scope.row.isFrozen == '1'?'是':'否'}}</template></el-table-column>
      <el-table-column prop="isForever" label="是否永久" width="120">
        <template slot-scope="scope">{{scope.row.isForever == '1'?'是':'否'}}</template></el-table-column>
      <el-table-column prop="totalGoldCoinVal" label="当前总金额" width="120">
        <template slot-scope="scope">{{scope.row.totalGoldCoinVal == '1'?'是':'否'}}</template></el-table-column>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="道具资产表id">
          <el-input v-model="add_form.aId" placeholder="请输入道具资产表id" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="获得途径">
          <el-input v-model="add_form.getFrom" placeholder="请输入获得途径" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="是否已绑定">
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item label="获得途径">
          <el-input v-model="edit_form.getFrom" placeholder="请输入获得途径" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="是否已绑定">
