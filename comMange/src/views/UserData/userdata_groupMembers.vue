...
<template>
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="成员ID" label-width="100px">
        <el-input v-model="find_form.data.memberId" placeholder="请输入成员ID"></el-input>
      </el-form-item>
      <el-form-item label="群名片" label-width="100px">
        <el-input v-model="find_form.data.groupCard" placeholder="请输入群名片"></el-input>
      </el-form-item>
      <el-form-item label="邀请人id" label-width="100px">
        <el-input v-model="find_form.data.inviter" placeholder="请输入邀请人id"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="memberId" label="成员ID" width="120"></el-table-column>
      <el-table-column prop="groupCard" label="群名片" width="120"></el-table-column>
      <el-table-column prop="inviter" label="邀请人id" width="120"></el-table-column>
      <el-table-column prop="joinTime" label="加入时间" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="群ID">
          <el-input v-model="add_form.groupId" placeholder="请输入成员ID" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="成员ID">
          <el-input v-model="add_form.memberId" placeholder="请输入成员ID" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="群名片">
          <el-input v-model="add_form.groupCard" placeholder="请输入群名片" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="邀请人id">
          <el-input v-model="add_form.inviter" placeholder="请输入邀请人id" autocomplete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="群名片">
          <el-input v-model="edit_form.groupCard" placeholder="请输入群名片" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  mounted() {
    ...
    getDataList("u1", "Groupmember", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("u1", "Groupmember",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("u1", "Groupmember",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("u1", "Groupmember",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("u1", "Groupmember",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
