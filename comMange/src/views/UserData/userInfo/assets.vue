<template>
  ...
  <div id="assets" class="shadow_container">
    <div class="pageTitle">
      道具资产
      <el-button type="primary" size="small" @click="toDetails('auction')">去拍卖行</el-button>
    </div>

    <!-- 标签页 -->
    <el-tabs type="card" v-model="activeName" @tab-click="switchTab">
      <el-tab-pane label="道具" name="Asset" :rpmtype="2"></el-tab-pane>
      <el-tab-pane label="优惠券" name="PersonalCoupon" :rpmtype="1"></el-tab-pane>
      <el-tab-pane label="房产" name="SpaHousePro" :rpmtype="3"></el-tab-pane>
    </el-tabs>

    <!-- 表格 -->
    <el-table :data="data_list" border style="width: 100%" @selection-change="select">
      <el-table-column type="selection" width="55"></el-table-column>
      <el-table-column prop="assName" label="道具名称" width="120"></el-table-column>
      ...
      <el-table-column prop="getFrom" label="获得途径" width="150"></el-table-column>
      ...
      <el-table-column prop="isFrozen" label="道具状态" width="100">
        <template slot-scope="scope">
          ...
          <span v-else-if="scope.row.isFrozen == 1" class="warning">拍卖中</span>
          <span v-else-if="scope.row.isFrozen == 2" class="success">使用中</span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="creationtime" label="创建日期" width="180"></el-table-column>
