<template>
  <!-- 优惠券 -->
  <div id="coupon" class="shadow_container">
    <div class="pageTitle">{{ nickname }}优惠券</div>

    <!-- 标签页 -->
    <el-tabs type="card" v-model="activeName">
      <el-tab-pane label="优惠券列表" name="cusCoupon">
        <!-- 表格 -->
      ...
      <el-tab-pane label="优惠券记录" name="cusCouponLog">
        <!-- 表格 -->
...
export default {
  ...
  methods: {
    ...
    pageChange(type, page) {
      ...
      var list = v == "cusCoupon" ? "data_list" : "log_list";
      getDataList(
        this.model,
        this.control,
        1,
  ...
  watch: {
    ...
    activeName(v) {
      this.control = v;
      this.operate = v == "cusCoupon" ? "couponList" : "list";
      var list = v == "cusCoupon" ? "data_list" : "log_list";
      getDataList(
        this.model,
        this.control,
