    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="地产所有者" label-width="100px">
        <el-input
          ...
          placeholder="请输入地产所有者"
        ></el-input>
      </el-form-item>
      <el-form-item label="地产位置信息" label-width="100px">
        <el-input
          v-model="find_form.data.landinfo"
          placeholder="请输入地产位置信息"
        ></el-input>
      </el-form-item>
      <el-form-item label="地产经纬度" label-width="100px">
        <el-input
          v-model="find_form.data.landCP"
          placeholder="请输入地产经纬度"
        ></el-input>
      </el-form-item>
      <el-form-item label="地产类型" label-width="100px">
        <el-select
          v-model="find_form.data.landtype"
          placeholder="请选择地产类型"
        >
      ...
      <el-form-item label="地产状态" label-width="100px">
        <el-select
          v-model="find_form.data.landstate"
          placeholder="请选择地产状态"
        >
      ...
      <el-form-item label="缩略图" label-width="100px">
        <el-input
          v-model="find_form.data.landico"
          placeholder="请输入缩略图"
        ></el-input>
      </el-form-item>
      <el-form-item label="地产用户标识" label-width="100px">
        <el-input
          v-model="find_form.data.landUM"
          placeholder="请输入地产用户标识"
        ></el-input>
      </el-form-item>
