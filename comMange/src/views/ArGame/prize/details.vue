<template>
  <div id="prize_details" class="shadow_container">
    <div class="pageTitle">奖品详情</div>
    <el-form label-width="100px">
      <el-form-item label="奖品名称">
        <el-input v-model="data_info.prizeName"></el-input>
      </el-form-item>

      <el-form-item label="奖品道具">
      ...
      <el-form-item label="奖品类型">
        <el-select v-model="data_info.prizeType">
