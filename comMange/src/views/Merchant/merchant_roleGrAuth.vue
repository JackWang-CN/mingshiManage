  ...
  <div id="store" class="shadow_container">
    ...
    >
      ...
      <el-table-column prop="authorityType" label="权限类型" width="120">
        <template slot-scope="scope">{{
          scope.row.authorityType == "0"
            ? "菜单"
            : scope.row.authorityType == "1"
            ? "子页面"
            : "按钮"
        }}</template>
      </el-table-column>
    ...
    >
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        ...
        <el-form-item label="权限标识">
          <el-input
            v-model="add_form.authorityFlag"
            placeholder="请输入权限标识"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="权限名称">
          <el-input
            v-model="add_form.authorityName"
            placeholder="请输入权限名称"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="权限类型">
          <el-select
            v-model="add_form.authorityType"
            placeholder="请选择权限类型"
          >
            <el-option label="菜单" value="0"></el-option>
            <el-option label="子页面" value="1"></el-option>
    ...
    >
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item label="权限标识">
          <el-input
            v-model="edit_form.authorityFlag"
            placeholder="请输入权限标识"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="权限名称">
          <el-input
            v-model="edit_form.authorityName"
            placeholder="请输入权限名称"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="权限url">
          <el-input
            v-model="edit_form.authorityUrl"
            placeholder="请输入权限url"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="权限类型">
          <el-select
            v-model="edit_form.authorityType"
            placeholder="请选择权限类型"
          >
            <el-option label="菜单" :value="0"></el-option>
            <el-option label="子页面" :value="1"></el-option>
