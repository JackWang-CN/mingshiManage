  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="优惠券id" label-width="100px">
        <el-input v-model="find_form.data.couponId" placeholder="请输入优惠券id"></el-input>
      </el-form-item>
      <el-form-item label="优惠券批次号" label-width="100px">
        <el-input v-model="find_form.data.batchNum" placeholder="请输入优惠券批次号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="商家id" label-width="100px">
        <el-input v-model="find_form.data.storeId" placeholder="请输入商家id"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="couponId" label="优惠券id" width="80"></el-table-column>
      <el-table-column prop="batchNum" label="优惠券批次号" width="120"></el-table-column>
      <el-table-column fixed prop="couponType" label="券类型" width="80">        
        <template slot-scope="scope">{{scope.row.couponType == '0'?'折扣券':scope.row.couponType == '1'? '抵扣券':'兑换券'}}</template>
      </el-table-column>
      <el-table-column prop="resId" label="资源id" width="120"></el-table-column>
      <el-table-column prop="storeId" label="商家id" width="120"></el-table-column>
      ...
      <el-table-column prop="supId" label="叠加策略模板" width="120"></el-table-column>
