  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="商品名称" label-width="100px">
        <el-input
          v-model="find_form.data.productName"
          placeholder="请输入商品名称"
        ></el-input>
      </el-form-item>
      <el-form-item label="详情描述" label-width="100px">
        <el-input
          v-model="find_form.data.detailDes"
          placeholder="请输入详情描述"
        ></el-input>
      </el-form-item>
      <el-form-item label="商品类别" label-width="100px">
        <el-input
          v-model="find_form.data.productType"
          placeholder="请输入商品类别"
        ></el-input>
      </el-form-item>
