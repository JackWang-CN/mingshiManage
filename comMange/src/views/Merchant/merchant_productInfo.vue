...
<template>
  <div id="store" class="shadow_container">
    <div class="pageTitle">商品信息管理</div>
    <!-- 查询条件 -->
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="商品ID" label-width="100px">
        <el-input v-model="find_form.data.productId" placeholder="请输入商品ID"></el-input>
      </el-form-item>
      <el-form-item label="商品名称" label-width="100px">
        <el-input v-model="find_form.data.productName" placeholder="请输入商品名称"></el-input>
      </el-form-item>
      <el-form-item label="详情描述" label-width="100px">
        <el-input v-model="find_form.data.detailDes" placeholder="请输入详情描述"></el-input>
      </el-form-item>
      <el-form-item label="商品类别" label-width="100px">
        <el-input v-model="find_form.data.productType" placeholder="请输入商品类别"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="productId" label="商品ID" width="80"></el-table-column>
      <el-table-column prop="productName" label="商品名称" width="120"></el-table-column>
      <el-table-column prop="productIco" label="商品图片" width="120"></el-table-column>
      <el-table-column prop="detailDes" label="详情描述" width="120"></el-table-column>
      <el-table-column prop="productType" label="商品类别" width="120"></el-table-column>
      ...
      <el-table-column prop="reqStatus" label="是否禁用" width="120">      
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="商品名称">
          <el-input v-model="add_form.productName" placeholder="请输入商品名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品图片">
          <el-input v-model="add_form.productIco" placeholder="请输入商品图片" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="详情描述">
          <el-input v-model="add_form.detailDes" placeholder="请输入详情描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品类别">
          <el-input v-model="add_form.productType" placeholder="请输入商品类别" autocomplete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="商品名称">
          <el-input v-model="edit_form.productName" placeholder="请输入商品名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品图片">
          <el-input v-model="edit_form.productIco" placeholder="请输入商品图片" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="详情描述">
          <el-input v-model="edit_form.detailDes" placeholder="请输入详情描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品类别">
          <el-input v-model="edit_form.productType" placeholder="请输入商品类别" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="是否禁用">
...
export default {
  ...
  mounted() {
    ...
    getDataList("m1", "Productinfo", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("m1", "Productinfo",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("m1", "Productinfo",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("m1", "Productinfo",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("m1", "Productinfo",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
