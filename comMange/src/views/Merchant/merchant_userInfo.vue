  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="用户名" label-width="100px">
        <el-input
          v-model="find_form.data.userName"
          placeholder="请输入用户名"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="所属角色组id" label-width="100px">
        <el-input
          ...
          placeholder="请输入所属角色组id"
        ></el-input>
      </el-form-item>
      <el-form-item label="安全邮箱" label-width="100px">
        <el-input
          v-model="find_form.data.email"
          placeholder="请输入安全邮箱"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否超级管理员" label-width="100px">
        <el-select
          v-model="find_form.data.isAdministrator"
      ...
      <el-form-item label="真实姓名" label-width="100px">
        <el-input
          v-model="find_form.data.realName"
          placeholder="请输入真实姓名"
        ></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        ...
        <el-form-item label="是否超级管理员">
          <el-select
            v-model="add_form.isAdministrator"
            placeholder="请选择是否超级管理员"
          >
            <el-option label="是" value="1"></el-option>
            <el-option label="否" value="0"></el-option>
    ...
    >
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item label="商户名称">
          <el-input
            v-model="edit_form.merchantname"
            placeholder="请输入商户名称"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否超级管理员">
          <el-select
            v-model="edit_form.isAdministrator"
            placeholder="请选择是否超级管理员"
          >
            <el-option label="是" value="1"></el-option>
            <el-option label="否" value="0"></el-option>
