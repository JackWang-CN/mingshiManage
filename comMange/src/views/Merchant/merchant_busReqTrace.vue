  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="记录编号" label-width="100px">
        <el-input
          v-model="find_form.data.recordId"
          placeholder="请输入记录编号"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="情况记录" label-width="100px">
        <el-input
          v-model="find_form.data.caseRecord"
          placeholder="请输入情况记录"
        ></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        ...
        <el-form-item label="客户经理">
          <el-input
            v-model="add_form.customManager"
            placeholder="请输入客户经理"
            autocomplete="off"
          ></el-input>
        </el-form-item>
    ...
    >
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="客户经理">
          <el-input
            v-model="edit_form.customManager"
            placeholder="请输入客户经理"
            autocomplete="off"
          ></el-input>
        </el-form-item>
