...
<template>
  <div id="store" class="shadow_container">
    <div class="pageTitle">业务请求跟踪</div>
    <!-- 查询条件 -->
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="记录编号" label-width="100px">
        <el-input v-model="find_form.data.recordId" placeholder="请输入记录编号"></el-input>
      </el-form-item>
      <el-form-item label="客户经理" label-width="100px">
        <el-input v-model="find_form.data.customManager" placeholder="请输入客户经理"></el-input>
      </el-form-item>
      <el-form-item label="情况记录" label-width="100px">
        <el-input v-model="find_form.data.caseRecord" placeholder="请输入情况记录"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="recordId" label="记录编号" width="120"></el-table-column>
      <el-table-column fixed prop="traceTime" label="跟踪时间" width="80"></el-table-column>
      <el-table-column prop="customManager" label="客户经理" width="120"></el-table-column>
      <el-table-column prop="caseRecord" label="情况记录" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="记录编号">
          <el-input v-model="add_form.recordId" placeholder="请输入记录编号" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="客户经理">
          <el-input v-model="add_form.customManager" placeholder="请输入客户经理" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="情况记录">
          <el-input v-model="add_form.caseRecord" placeholder="请输入情况记录" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="客户经理">
          <el-input v-model="edit_form.customManager" placeholder="请输入客户经理" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="情况记录">
          <el-input v-model="edit_form.caseRecord" placeholder="请输入情况记录" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  mounted() {
    ...
    getDataList("m1", "Busreqtrace", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("m1", "Busreqtrace",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("m1", "Busreqtrace",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("m1", "Busreqtrace",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("m1", "Busreqtrace",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
