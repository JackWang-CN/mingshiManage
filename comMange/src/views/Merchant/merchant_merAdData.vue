  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="描述" label-width="100px">
        <el-input
          v-model="find_form.data.desInfo"
          placeholder="请输入描述"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="广告资源URL" label-width="100px">
        <el-input
          v-model="find_form.data.adUrl"
          placeholder="请输入广告资源URL"
        ></el-input>
      </el-form-item>
      <el-form-item label="请求状态" label-width="100px">
        <el-select
          v-model="find_form.data.reqStatus"
          placeholder="请选择请求状态"
        >
    ...
    >
      ...
      <el-table-column prop="reqStatus" label="请求状态" width="120">
        <template slot-scope="scope">{{
          scope.row.reqStatus == "0" ? "正常" : "(禁用)删除或者未启用"
        }}</template>
      </el-table-column>
      <el-table-column
        prop="creationtime"
