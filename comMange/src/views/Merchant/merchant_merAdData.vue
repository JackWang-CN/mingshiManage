...
<template>
  <div id="store" class="shadow_container">
    <div class="pageTitle">商户广告数据管理</div>
    <!-- 查询条件 -->
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="描述" label-width="100px">
        <el-input v-model="find_form.data.desInfo" placeholder="请输入描述"></el-input>
      </el-form-item>
      <el-form-item label="资源id" label-width="100px">
        <el-input v-model="find_form.data.resId" placeholder="请输入资源id"></el-input>
      </el-form-item>
      <el-form-item label="广告资源URL" label-width="100px">
        <el-input v-model="find_form.data.adUrl" placeholder="请输入广告资源URL"></el-input>
      </el-form-item>
      <el-form-item label="请求状态" label-width="100px">
        <el-select v-model="find_form.data.reqStatus" placeholder="请选择请求状态">
          <el-option label="正常" value="0"></el-option>
          <el-option label="(禁用)删除或者未启用" value="1"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="reqId" label="请求编号" width="80"></el-table-column>
      <el-table-column prop="desInfo" label="描述" width="120"></el-table-column>
      <el-table-column prop="resId" label="资源id" width="120"></el-table-column>
      <el-table-column prop="adUrl" label="广告资源URL" width="120"></el-table-column>
      <el-table-column prop="reqStatus" label="请求状态" width="120">      
        <template slot-scope="scope">{{scope.row.reqStatus == '0'?'正常':'(禁用)删除或者未启用'}}</template>
      </el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="描述">
          <el-input v-model="add_form.desInfo" placeholder="请输入描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="资源id">
          <el-input v-model="add_form.resId" placeholder="请输入资源id" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="广告资源URL">
          <el-input v-model="add_form.adUrl" placeholder="请输入广告资源URL" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="请求状态">
        <el-select v-model="add_form.reqStatus" placeholder="请选择请求状态">
          <el-option label="正常" value="0"></el-option>
          <el-option label="(禁用)删除或者未启用" value="1"></el-option>
        </el-select>
        </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="描述">
          <el-input v-model="edit_form.desInfo" placeholder="请输入描述" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="资源id">
          <el-input v-model="edit_form.resId" placeholder="请输入资源id" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="广告资源URL">
          <el-input v-model="edit_form.adUrl" placeholder="请输入广告资源URL" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="请求状态">
        <el-select v-model="edit_form.reqStatus" placeholder="请选择请求状态">
          <el-option label="正常" value="0"></el-option>
          <el-option label="(禁用)删除或者未启用" value="1"></el-option>
        </el-select>
        </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    getDataList("m1", "Meraddata", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("m1", "Meraddata",add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("m1", "Meraddata",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("m1", "Meraddata",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("m1", "Meraddata",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
