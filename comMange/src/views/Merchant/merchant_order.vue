  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="订单号" label-width="100px">
        <el-input v-model="find_form.data.orderId" placeholder="请输入订单号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="数量" label-width="100px">
        <el-input v-model="find_form.data.number" placeholder="请输入数量"></el-input>
      </el-form-item>
      <el-form-item label="金额" label-width="100px">
        <el-input v-model="find_form.data.amount" placeholder="请输入金额"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="orderId" label="订单号" width="80"></el-table-column>
      ...
      <el-table-column prop="orderStatus" label="订单状态" width="120">      
        <template slot-scope="scope">{{scope.row.orderStatus == '0'?'未支付':scope.row.orderStatus == '1'?'支付成功':scope.row.orderStatus == '2'?'支付中(等待回调)':'支付失败'}}</template>
      </el-table-column>
