  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="更新设备" label-width="100px">
        <el-input v-model="find_form.data.updateDevice" placeholder="请输入更新设备"></el-input>
      </el-form-item>
      <el-form-item label="更新场景" label-width="100px">
        <el-input v-model="find_form.data.updateScene" placeholder="请输入更新场景"></el-input>
      </el-form-item>
      <el-form-item label="更新角色" label-width="100px">
        <el-input v-model="find_form.data.updateRole" placeholder="请输入更新角色"></el-input>
      </el-form-item>
      <el-form-item label="更新地址" label-width="100px">
        <el-input v-model="find_form.data.updateAddr" placeholder="请输入更新地址"></el-input>
      </el-form-item>
      <el-form-item label="当前版本号" label-width="100px">
        <el-input v-model="find_form.data.curVerNum" placeholder="请输入当前版本号"></el-input>
      </el-form-item>
      <el-form-item label="上一版本号" label-width="100px">
        <el-input v-model="find_form.data.prevVerNum" placeholder="请输入上一版本号"></el-input>
      </el-form-item>
      <el-form-item label="更新内容或描述" label-width="100px">
        <el-input v-model="find_form.data.upContent" placeholder="请输入更新内容或描述"></el-input>
      </el-form-item>
      <el-form-item label="是否强制更新">
        <el-select v-model="find_form.data.isForceUpdate" placeholder="请选择是否强制更新">
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="updateDevice" label="更新设备" width="80"></el-table-column>
      <el-table-column prop="updateScene" label="更新场景" width="120"></el-table-column>
      <el-table-column prop="updateRole" label="更新角色" width="120"></el-table-column>
      <el-table-column prop="updateTime" label="更新时间" width="300"></el-table-column>
      <el-table-column prop="curVerNum" label="当前版本号" width="300"></el-table-column>
      <el-table-column prop="prevVerNum" label="上一版本号" width="300"></el-table-column>
      <el-table-column prop="upContent" label="更新内容或描述" width="300"></el-table-column>
      <el-table-column prop="updateAddr" label="更新地址" width="300"></el-table-column>
      <el-table-column prop="isForceUpdate" label="是否强制更新" width="50">
        <template slot-scope="scope">{{scope.row.isForceUpdate == '1'?'是':'否'}}</template></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="更新设备">
          <el-input v-model="add_form.updateDevice" placeholder="请输入更新设备" ></el-input>
        </el-form-item>
        <el-form-item label="更新场景">
          <el-input v-model="add_form.updateScene" placeholder="请输入更新场景" ></el-input>
        </el-form-item>
        <el-form-item label="更新角色">
          <el-input v-model="add_form.updateRole" placeholder="请输入更新角色" ></el-input>
        </el-form-item>
        <el-form-item label="更新地址">
          <el-input v-model="add_form.updateAddr" placeholder="请输入更新地址" ></el-input>
        </el-form-item>
        <el-form-item label="当前版本号">
          <el-input v-model="add_form.curVerNum" placeholder="请输入当前版本号" ></el-input>
        </el-form-item>
        <el-form-item label="上一版本号">
          <el-input v-model="add_form.prevVerNum" placeholder="请输入上一版本号" ></el-input>
        </el-form-item>
        <el-form-item label="更新内容或描述">
          <el-input v-model="add_form.upContent" placeholder="请输入更新内容或描述" ></el-input>
        </el-form-item>
      <el-form-item label="是否强制更新">
        <el-select v-model="add_form.isForceUpdate" placeholder="请选择是否强制更新">
          <el-option label="是" value="1"></el-option>
          <el-option label="否" value="0"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="更新设备">
          <el-input v-model="edit_form.updateDevice" placeholder="请输入更新设备" ></el-input>
        </el-form-item>
        <el-form-item label="更新场景">
          <el-input v-model="edit_form.updateScene" placeholder="请输入更新场景" ></el-input>
        </el-form-item>
        <el-form-item label="更新角色">
          <el-input v-model="edit_form.updateRole" placeholder="请输入更新角色" ></el-input>
        </el-form-item>
        <el-form-item label="更新地址">
          <el-input v-model="edit_form.updateAddr" placeholder="请输入更新地址" ></el-input>
        </el-form-item>
        <el-form-item label="当前版本号">
          <el-input v-model="edit_form.curVerNum" placeholder="请输入当前版本号" ></el-input>
        </el-form-item>
        <el-form-item label="上一版本号">
          <el-input v-model="edit_form.prevVerNum" placeholder="请输入上一版本号" ></el-input>
        </el-form-item>
        <el-form-item label="更新内容或描述">
          <el-input v-model="edit_form.upContent" placeholder="请输入更新内容或描述" ></el-input>
        </el-form-item>
      <el-form-item label="是否强制更新">
        <el-select v-model="edit_form.isForceUpdate" placeholder="请选择是否强制更新">
          <el-option label="是" value="1"></el-option>
          <el-option label="否" value="0"></el-option>
        </el-select>
      </el-form-item>
