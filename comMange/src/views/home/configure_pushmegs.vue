  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="推送信息id" label-width="100px">
        <el-input
          v-model="find_form.data.pushMegsId"
          placeholder="请输入推送信息id"
        ></el-input>
      </el-form-item>
      <el-form-item label="公告id" label-width="100px">
        <el-input
          v-model="find_form.data.noticeId"
          placeholder="请输入公告id"
        ></el-input>
      </el-form-item>
      <el-form-item label="推送模板id" label-width="100px">
        <el-input
          v-model="find_form.data.pushId"
      ...
      <el-form-item label="公告内容" label-width="100px">
        <el-input
          v-model="find_form.data.noticeCentent"
          placeholder="请输入公告内容"
        ></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="公告id">
          <el-input
            v-model="add_form.noticeId"
            placeholder="请输入公告id"
          ></el-input>
        </el-form-item>
        <el-form-item label="推送模板id">
          <el-input
            v-model="add_form.pushId"
            placeholder="请输入推送模板id"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="公告内容">
          <el-input
            v-model="add_form.noticeCentent"
            placeholder="请输入公告内容"
          ></el-input>
        </el-form-item>
    ...
    >
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="公告id">
          <el-input
            v-model="edit_form.noticeId"
            placeholder="请输入公告id"
          ></el-input>
        </el-form-item>
        <el-form-item label="推送模板id">
          <el-input
            v-model="edit_form.pushId"
            placeholder="请输入推送模板id"
          ></el-input>
        </el-form-item>
        <el-form-item label="公告标题">
          <el-input
            v-model="edit_form.noticeTitle"
            placeholder="请输入公告标题"
          ></el-input>
        </el-form-item>
        <el-form-item label="公告内容">
          <el-input
            v-model="edit_form.noticeCentent"
            placeholder="请输入公告内容"
          ></el-input>
        </el-form-item>
        <el-form-item label="公告类型">
          <el-input
            v-model="edit_form.noticeType"
            placeholder="请输入公告类型"
          ></el-input>
        </el-form-item>
        <el-form-item label="受众类型">
          <el-input
            v-model="edit_form.noticeAudience"
            placeholder="请输入受众类型"
          ></el-input>
        </el-form-item>
        <el-form-item label="是否公布">
          <el-select
            v-model="edit_form.noticePublish"
            placeholder="请选择是否公布"
          >
            <el-option label="是" value="1"></el-option>
            <el-option label="否" value="0"></el-option>
