  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="权限类型" label-width="100px">
        <el-input v-model="find_form.data.authorityType" placeholder="请输入权限类型"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="authorityName" label="权限名称" width="300"></el-table-column>
      <el-table-column prop="authorityUrl" label="权限url" width="300"></el-table-column>
      <el-table-column prop="authorityType" label="权限类型" width="300"></el-table-column>
      <el-table-column prop="isDisable" label="是否公布" width="50">
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="权限ID">
          <el-input v-model="add_form.authorityId" placeholder="请输入权限ID" ></el-input>
        </el-form-item>
        <el-form-item label="角色ID">
          <el-input v-model="add_form.roleId" placeholder="请输入角色ID" ></el-input>
        </el-form-item>
        <el-form-item label="权限标识">
          <el-input v-model="add_form.authorityFlag" placeholder="请输入权限标识" ></el-input>
        </el-form-item>
        <el-form-item label="权限名称">
          <el-input v-model="add_form.authorityName" placeholder="请输入权限名称" ></el-input>
        </el-form-item>
        <el-form-item label="权限url">
          <el-input v-model="add_form.authorityUrl" placeholder="请输入权限url" ></el-input>
        </el-form-item>
        <el-form-item label="权限类型">
          <el-input v-model="add_form.authorityType" placeholder="请输入权限类型" ></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="角色ID">
          <el-input v-model="edit_form.roleId" placeholder="请输入角色ID" ></el-input>
        </el-form-item>
        <el-form-item label="权限标识">
          <el-input v-model="edit_form.authorityFlag" placeholder="请输入权限标识" ></el-input>
        </el-form-item>
        <el-form-item label="权限名称">
          <el-input v-model="edit_form.authorityName" placeholder="请输入权限名称" ></el-input>
        </el-form-item>
        <el-form-item label="权限url">
          <el-input v-model="edit_form.authorityUrl" placeholder="请输入权限url" ></el-input>
        </el-form-item>
        <el-form-item label="权限类型">
          <el-input v-model="edit_form.authorityType" placeholder="请输入权限类型" ></el-input>
        </el-form-item>
      <el-form-item label="是否禁用">
...
export default {
  ...
  mounted() {
    ...
    getDataList("c1", "Rolegrauth", get_form, "store_list", this);
  },
  methods: {
    queryData() {
    ...
    user_add() {
      ...
      putcreate("c1","Rolegrauth",this.add_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    // 修改当前
    user_update() {
      patchedit("c1","Rolegrauth",this.edit_form).then((res) => {
        console.log(res);
        if (res != null) {
    ...
    user_delete(val) {
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deleteuser("c1","Rolegrauth",del).then((res) => {
          console.log(res);
          if (res != null) {
    ...
    delete_list(){
      this.$confirm("确定要删除吗(｀・ω・´)", "提示", {
        ...
        deletelist("c1","Rolegrauth",dellist).then((res) => {
          console.log(res);
          if (res != null) {
            this.$message.success("删除成功");
            this.resetForm();
