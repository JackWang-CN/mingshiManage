  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      <el-form-item label="公告标题" label-width="100px">
        <el-input v-model="find_form.data.noticeTitle" placeholder="公告标题"></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否公布">
        <el-select v-model="find_form.data.noticePublish" placeholder="是否公布">
    ...
    >
      ...
      <el-table-column prop="noticeContent" label="公告内容" width="500"></el-table-column>
      <el-table-column prop="noticeType" label="公告类型" width="150"></el-table-column>
      <el-table-column prop="noticeAudience" label="受众类型" width="150"></el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button @click="show_edit(scope.row)" type="primary" size="small">编辑</el-button>
          <el-button
