    ...
    >
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="数据库名">
          <el-input
            v-model="add_form.dbName"
            placeholder="请输入数据库名"
          ></el-input>
        </el-form-item>
        <el-form-item label="商家名">
          <el-input
            v-model="add_form.merchantId"
            placeholder="请输入商家名"
          ></el-input>
        </el-form-item>
        <el-form-item label="数据库地址">
          <el-input
            v-model="add_form.dbAddr"
            placeholder="请输入数据库地址"
          ></el-input>
        </el-form-item>
        <el-form-item label="SA超级管理员">
          <el-input
            v-model="add_form.dbSa"
            placeholder="请输入数据库SA超级管理员"
          ></el-input>
        </el-form-item>
        <el-form-item label="数据库PW密码">
          <el-input
            v-model="add_form.dbPw"
