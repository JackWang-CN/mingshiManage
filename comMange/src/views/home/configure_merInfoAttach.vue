  ...
  <div id="store" class="shadow_container">
    ...
    <el-form ref="find_form" :model="find_form" label-width="80px">
      ...
      <el-form-item label="附件ID" label-width="100px">
        <el-input v-model="find_form.data.attachId" placeholder="请输入附件ID"></el-input>
      </el-form-item>
      <el-form-item label="附件名称" label-width="100px">
        <el-input v-model="find_form.data.attachName" placeholder="请输入附件名称"></el-input>
      </el-form-item>
      <el-form-item label="附件地址" label-width="100px">
        <el-input v-model="find_form.data.attachAddr" placeholder="请输入附件地址"></el-input>
      </el-form-item>
    ...
    <el-table :data="store_list" border style="width: 100%"  @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed prop="merId" label="商家ID" width="80"></el-table-column>
      <el-table-column prop="attachId" label="附件ID" width="120"></el-table-column>
      <el-table-column prop="attachName" label="附件名称" width="120"></el-table-column>
      <el-table-column prop="attachAddr" label="附件地址" width="120"></el-table-column>
    ...
    <el-dialog title="添加类别" :visible.sync="dialogFormVisibleOfAdd" width="40%">
      ...
      <el-form ref="add_form" :model="add_form" label-width="120px">
        <el-form-item label="附件ID">
          <el-input v-model="add_form.attachId" placeholder="请输入附件ID" ></el-input>
        </el-form-item>
        <el-form-item label="附件名称">
          <el-input v-model="add_form.attachName" placeholder="请输入附件名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="附件地址">
          <el-input v-model="add_form.attachAddr" placeholder="请输入附件地址" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改类别" :visible.sync="dialogFormVisibleOfEdit" width="40%">
      ...
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        <el-form-item label="附件名称">
          <el-input v-model="edit_form.attachName" placeholder="请输入附件名称" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="附件地址">
          <el-input v-model="edit_form.attachAddr" placeholder="请输入附件地址" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
